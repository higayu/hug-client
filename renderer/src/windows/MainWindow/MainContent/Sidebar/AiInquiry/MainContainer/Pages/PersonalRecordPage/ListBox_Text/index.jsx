 ...
 * 
 * @param {{ childId: string|number, monthStr: string, onMonthChange?: (month: string) => void }} props
 */
export default function ListBox_Text({ childId, monthStr = "", onMonthChange }) {
  ...
  }, [childId, selectedDate, serviceRecords]);
  ...
  return (
    <div className="space-y-3 px-1 py-2 bg-slate-100 rounded-lg">
      ...
      <div>
        <textarea
          className="h-[400px] w-full rounded bg-gray-700 p-3 text-white resize-none focus:ring-2 focus:ring-amber-500 focus:outline-none"
          value={selectedNote}
          readOnly
          placeholder={
            !childId
